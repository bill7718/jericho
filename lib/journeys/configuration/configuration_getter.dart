...
///
/// Retrieves configuration used by the rest of the Application
///
class ConfigurationGetter implements ErrorMessageGetter {

  ///
  /// Hard coded values for the text which appears on the screens
  ///
  ...
  ///
  /// Returns the page title based on the [id]. This normally appears on the [AppBar]
  ///
  /// If the value is not found the method returns an empty String.
  ///
  ...
  ///
  /// Returns general screen text based on the [id].
  ///
  /// If the value is not found the method returns an empty String.
  ///
  ...
  ///
  /// Returns field labels based on the [id].
  ///
  /// If the value is not found the method returns an empty String.
  ///
  ...
  ///
  /// Returns button text based on the [id].
  ///
  /// If the value is not found the method returns an empty String.
  ///
  ...
  ///
  /// Returns error messages based on the [id].
  ///
  /// If the value is not found the method returns an empty String.
  ///
  @override
